...
/*PROTECTED REGION ID(PortTypeImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void PortType::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(PortTypeImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject PortType::eGet(::ecore::EInt _featureID,
...
void PortType::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean PortType::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kevoree::KevoreePackage::NAMEDELEMENT__NAME:
...
void PortType::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr PortType::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kevoree::KevoreePackage_ptr > (::kevoree::KevoreePackage::_instance())->getPortType();
    return _eclass;
}
