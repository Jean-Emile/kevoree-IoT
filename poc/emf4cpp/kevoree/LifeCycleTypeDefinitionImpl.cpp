...
/*
 * kevoree/LifeCycleTypeDefinitionImpl.cpp
...
/*PROTECTED REGION ID(LifeCycleTypeDefinitionImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void LifeCycleTypeDefinition::_initialize()
{
    // Supertypes
    ::kevoree::TypeDefinition::_initialize();

    // Rerefences

    /*PROTECTED REGION ID(LifeCycleTypeDefinitionImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject LifeCycleTypeDefinition::eGet(::ecore::EInt _featureID,
...
void LifeCycleTypeDefinition::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean LifeCycleTypeDefinition::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kevoree::KevoreePackage::NAMEDELEMENT__NAME:
...
void LifeCycleTypeDefinition::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr LifeCycleTypeDefinition::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kevoree::KevoreePackage_ptr > (::kevoree::KevoreePackage::_instance())->getLifeCycleTypeDefinition();
    return _eclass;
}
