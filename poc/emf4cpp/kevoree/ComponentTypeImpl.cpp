...
/*PROTECTED REGION ID(ComponentTypeImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void ComponentType::_initialize()
{
    // Supertypes
    ...
    for (size_t i = 0; i < m_required->size(); i++)
    {
        ...
        (*m_required)[i]->_setEContainer(
                this,
                ::kevoree::KevoreePackage::_instance()->getComponentType__required());
    }
    for (size_t i = 0; i < m_integrationPatterns->size(); i++)
    {
        (*m_integrationPatterns)[i]->_initialize();
        (*m_integrationPatterns)[i]->_setEContainer(
                this,
                ::kevoree::KevoreePackage::_instance()->getComponentType__integrationPatterns());
    }
    if (m_extraFonctionalProperties)
    {
        m_extraFonctionalProperties->_initialize();
        m_extraFonctionalProperties->_setEContainer(
                this,
                ::kevoree::KevoreePackage::_instance()->getComponentType__extraFonctionalProperties());
    }
    for (size_t i = 0; i < m_provided->size(); i++)
    {
        ...
        (*m_provided)[i]->_setEContainer(
                this,
                ::kevoree::KevoreePackage::_instance()->getComponentType__provided());
    }

    /*PROTECTED REGION ID(ComponentTypeImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject ComponentType::eGet(::ecore::EInt _featureID,
...
void ComponentType::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean ComponentType::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kevoree::KevoreePackage::NAMEDELEMENT__NAME:
...
void ComponentType::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr ComponentType::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kevoree::KevoreePackage_ptr > (::kevoree::KevoreePackage::_instance())->getComponentType();
    return _eclass;
}
