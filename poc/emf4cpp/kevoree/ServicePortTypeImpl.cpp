...
/*
 * kevoree/ServicePortTypeImpl.cpp
...
/*PROTECTED REGION ID(ServicePortTypeImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void ServicePortType::_initialize()
{
    // Supertypes
    ...
    {
        (*m_operations)[i]->_initialize();
        (*m_operations)[i]->_setEContainer(
                this,
                ::kevoree::KevoreePackage::_instance()->getServicePortType__operations());
    }

    /*PROTECTED REGION ID(ServicePortTypeImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject ServicePortType::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::kevoree::KevoreePackage::PORTTYPE__SYNCHRONE:
    {
        ...
        return _any;
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__OPERATIONS:
    {
        _any = m_operations->asEListOf< ::ecore::EObject > ();
    }
        return _any;
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__INTERFACE:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EString >::toAny(_any,
                m_interface);
    }
...
void ServicePortType::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__OPERATIONS:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::kevoree::ServicePortType::getOperations().clear();
        ::kevoree::ServicePortType::getOperations().insert_all(*_t0);
    }
        return;
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__INTERFACE:
    {
...
::ecore::EBoolean ServicePortType::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::kevoree::KevoreePackage::NAMEDELEMENT__NAME:
    ...
    case ::kevoree::KevoreePackage::PORTTYPE__SYNCHRONE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EBoolean >::is_set(
                m_synchrone);
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__OPERATIONS:
        return m_operations && m_operations->size();
    case ::kevoree::KevoreePackage::SERVICEPORTTYPE__INTERFACE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_interface);
...
void ServicePortType::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr ServicePortType::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::kevoree::KevoreePackage_ptr > (::kevoree::KevoreePackage::_instance())->getServicePortType();
    return _eclass;
}
